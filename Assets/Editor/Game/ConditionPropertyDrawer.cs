...
namespace EldwynGrove.Edit
{
    ...
    public class ConditionPropertyDrawer : PropertyDrawer
    {
        ...
        /*--------------------------------------------------------------------------------------- 
        | --- OnGUI: Overwritten to Create a Custom Inspector Field for Condition Selection --- |
        ---------------------------------------------------------------------------------------*/
        ...
        /*------------------------------------------------------------------------------------------------------
        | --- GetPropertyHeight: Overwritten to Return Dynamic Heights Based on Selected Predicate's Needs --- |
        ------------------------------------------------------------------------------------------------------*/
